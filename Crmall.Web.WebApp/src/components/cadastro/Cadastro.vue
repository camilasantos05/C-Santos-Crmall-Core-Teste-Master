<template>
    <div class="formulario">
        <form @submit.prevent="salvar(cliente, $event)">

        <fieldset>
            <legend>Cliente:</legend>
        <label for="nome"> Nome</label> 
        <input type="text" id="nome" v-model="cliente.nome" /><br />

        <div class="date-picker">
            <label for="nascimento">Data de nascimento</label>
            <date-picker type="date" v-model="cliente.dataNascimento" valueType="format"></date-picker> <br />
        </div>
        ...
        <fieldset>
          ...
          <div class="prop-form">
            ...
            <input type="text" id="cep" v-model="cliente.endereco.cep" />
            <button @click="buscarCep(cliente.endereco.cep,  $event)" class="button-cep">Preecher com o cep</button> 
            <br/>
          ...
          <div class="prop-form">
            ...
            <input type="text" id="logradouro" v-model="cliente.endereco.logradouro" /> <br/>
          </div>
          
          <div class="prop-form">
            <label for="numero">Numero</label> 
            <input type="text" id="numero" v-model="cliente.endereco.numero" /> <br/>
          </div>
        
         <div class="prop-form">
          <label for="complemento">Complemento</label> 
          <input type="text" id="complemento" v-model="cliente.endereco.complemento" /> <br/>
         </div>

        <div class="prop-form">
          <label for="bairro">Bairro</label> 
          <input type="text" id="bairro" v-model="cliente.endereco.bairro" /> <br/>
        </div>

        <div class="prop-form"> 
          <label for="cidade">Cidade</label> 
          <input type="text" id="cidade" v-model="cliente.endereco.cidade" /> <br/>
        </div>

        <div class="prop-form">
          <label for="estado">Estado</label> 
          <input type="text" id="estado" v-model="cliente.endereco.estado" /> <br/>
        </div>
        </fieldset>
                    ...
                    this.service.buscarPorId(this.id)
                                .then(cliente => {
                                    ...
                                    if(cliente.endereco === null){
                                        this.cliente.endereco = new Cliente().endereco;
                                    }                            
